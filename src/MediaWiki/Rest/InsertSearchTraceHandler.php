...
class InsertSearchTraceHandler extends SimpleHandler {
	/**
	 * @var SearchTracker
	 */
	private $tracker;
	...
	public function execute() {
		...
		try {
			$res = $this->tracker->trace( (int)$data['namespace'], $data['dbkey'], $user );
		...
		throw new HttpException( 'Failed to insert search tracking data' );
	}
